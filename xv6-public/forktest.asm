...
00000020 <printf>:
{
  ...
  3c:	e8 a2 03 00 00       	call   3e3 <write>
}
  ...
  58:	31 db                	xor    %ebx,%ebx
{
  ...
  70:	6a 01                	push   $0x1
  72:	e8 6c 03 00 00       	call   3e3 <write>
  ...
  ce:	6a 01                	push   $0x1
  d0:	e8 0e 03 00 00       	call   3e3 <write>
}
  ...
  f5:	6a 01                	push   $0x1
  f7:	e8 e7 02 00 00       	call   3e3 <write>
      exit();
 ...
 117:	6a 01                	push   $0x1
 119:	e8 c5 02 00 00       	call   3e3 <write>
    exit();
...
stat(const char *n, struct stat *st)
{
 ...
 301:	e8 fd 00 00 00       	call   403 <open>
  if(fd < 0)
 ...
 315:	50                   	push   %eax
 316:	e8 00 01 00 00       	call   41b <fstat>
  close(fd);
 31b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 31e:	89 c6                	mov    %eax,%esi
  close(fd);
 320:	e8 c6 00 00 00       	call   3eb <close>
  return r;
