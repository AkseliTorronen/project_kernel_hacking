  ...
  13:	8d 5d f6             	lea    -0xa(%ebp),%ebx
{
  ...
  2a:	6a 00                	push   $0x0
  2c:	6a 00                	push   $0x0
  2e:	e8 e8 02 00 00       	call   31b <read>
	rc = getreadcount(); //getting read count (sysproc.c)
  33:	e8 eb 02 00 00       	call   323 <getreadcount>
	printf(1, "current count: %d\n\nDo you want to reset the counter? [y]\n",rc);
  38:	83 c4 0c             	add    $0xc,%esp
  3b:	50                   	push   %eax
  3c:	68 24 08 00 00       	push   $0x824
  41:	6a 01                	push   $0x1
  ...
  4a:	6a 02                	push   $0x2
  4c:	53                   	push   %ebx
  4d:	e8 6e 01 00 00       	call   1c0 <gets>
	if(strcmp(buffer,"y")==0){rc = resetread();printf(1, "Read count has been reset.\n");}
  52:	58                   	pop    %eax
  53:	5a                   	pop    %edx
  54:	68 ea 07 00 00       	push   $0x7ea
  59:	53                   	push   %ebx
  5a:	e8 71 00 00 00       	call   d0 <strcmp>
  5f:	83 c4 10             	add    $0x10,%esp
  62:	85 c0                	test   %eax,%eax
  64:	74 1a                	je     80 <main+0x80>
	rc = getreadcount(); //getting read count (sysproc.c)
  66:	e8 b8 02 00 00       	call   323 <getreadcount>
	printf(1, "read count currently: %d\n",rc);
  6b:	83 ec 04             	sub    $0x4,%esp
  6e:	50                   	push   %eax
  6f:	68 08 08 00 00       	push   $0x808
  74:	6a 01                	push   $0x1
  76:	e8 f5 03 00 00       	call   470 <printf>
	exit();
  7b:	e8 83 02 00 00       	call   303 <exit>
	if(strcmp(buffer,"y")==0){rc = resetread();printf(1, "Read count has been reset.\n");}
  80:	e8 a6 02 00 00       	call   32b <resetread>
  85:	50                   	push   %eax
  86:	50                   	push   %eax
  87:	68 ec 07 00 00       	push   $0x7ec
  8c:	6a 01                	push   $0x1
  8e:	e8 dd 03 00 00       	call   470 <printf>
  93:	83 c4 10             	add    $0x10,%esp
  96:	eb ce                	jmp    66 <main+0x66>
  98:	66 90                	xchg   %ax,%ax
  9a:	66 90                	xchg   %ax,%ax
  9c:	66 90                	xchg   %ax,%ax
  9e:	66 90                	xchg   %ax,%ax
...
stat(const char *n, struct stat *st)
{
 ...
 251:	e8 fd 00 00 00       	call   353 <open>
  if(fd < 0)
 ...
 265:	50                   	push   %eax
 266:	e8 00 01 00 00       	call   36b <fstat>
  close(fd);
 26b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 26e:	89 c6                	mov    %eax,%esi
  close(fd);
 270:	e8 c6 00 00 00       	call   33b <close>
  return r;
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 5e 08 00 00       	mov    $0x85e,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 645:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 14 0b 00 00       	mov    %eax,0xb14
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 14 0b 00 00       	mov    0xb14,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 14 0b 00 00       	mov    %eax,0xb14
}
