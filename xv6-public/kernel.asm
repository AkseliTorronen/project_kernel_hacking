...
80103804:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 e6 58 10 80 	movl   $0x801058e6,0x14(%eax)
  p->context = (struct context*)sp;
...
801041f3:	68 9f 7a 10 80       	push   $0x80107a9f
...
80104a40 <syscall>:
[SYS_resetread]    sys_resetread, //My change
};
...
80104a55:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num == SYS_read){count++;} //each time read is called count is increased
80104a58:	83 f8 05             	cmp    $0x5,%eax
80104a5b:	74 43                	je     80104aa0 <syscall+0x60>
  //when getreadcount is called, the current count is given to curproc
  if(num == SYS_getreadcount){curproc->readcount = count;}
80104a5d:	83 f8 16             	cmp    $0x16,%eax
80104a60:	75 26                	jne    80104a88 <syscall+0x48>
80104a62:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
80104a68:	89 53 14             	mov    %edx,0x14(%ebx)
  if(num == SYS_resetread){count=0;}
  
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a6b:	8b 14 85 00 78 10 80 	mov    -0x7fef8800(,%eax,4),%edx
    curproc->tf->eax = syscalls[num]();
80104a72:	ff d2                	call   *%edx
80104a74:	89 c2                	mov    %eax,%edx
80104a76:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104a81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(num == SYS_resetread){count=0;}
80104a88:	83 f8 17             	cmp    $0x17,%eax
80104a8b:	75 49                	jne    80104ad6 <syscall+0x96>
80104a8d:	c7 05 bc a5 10 80 00 	movl   $0x0,0x8010a5bc
80104a94:	00 00 00 
80104a97:	eb d2                	jmp    80104a6b <syscall+0x2b>
80104a99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(num == SYS_read){count++;} //each time read is called count is increased
80104aa0:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104aa7:	8b 14 85 00 78 10 80 	mov    -0x7fef8800(,%eax,4),%edx
80104aae:	85 d2                	test   %edx,%edx
80104ab0:	75 c0                	jne    80104a72 <syscall+0x32>
    cprintf("%d %s: unknown sys call %d\n",
80104ab2:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104ab3:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104ab6:	50                   	push   %eax
80104ab7:	ff 73 10             	pushl  0x10(%ebx)
80104aba:	68 dd 77 10 80       	push   $0x801077dd
80104abf:	e8 ec bb ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104ac4:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104ac7:	83 c4 10             	add    $0x10,%esp
80104aca:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
80104ad1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104ad4:	c9                   	leave  
80104ad5:	c3                   	ret    
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104ad6:	8d 50 ff             	lea    -0x1(%eax),%edx
80104ad9:	83 fa 16             	cmp    $0x16,%edx
80104adc:	77 d4                	ja     80104ab2 <syscall+0x72>
80104ade:	eb c7                	jmp    80104aa7 <syscall+0x67>
...
80104c92:	e8 b9 fc ff ff       	call   80104950 <argint>
...
80104cac:	8b 44 90 2c          	mov    0x2c(%eax,%edx,4),%eax
...
80104cf8:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80104d1d:	8d 76 00             	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
80104d20:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104d61:	e8 ea fb ff ff       	call   80104950 <argint>
...
80104d79:	e8 22 fc ff ff       	call   801049a0 <argptr>
...
80104dd1:	e8 7a fb ff ff       	call   80104950 <argint>
...
80104de9:	e8 b2 fb ff ff       	call   801049a0 <argptr>
...
80104e41:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104e44:	c7 44 90 2c 00 00 00 	movl   $0x0,0x2c(%eax,%edx,4)
80104e4b:	00 
  fileclose(f);
...
80104e93:	e8 08 fb ff ff       	call   801049a0 <argptr>
...
80104ed3:	e8 28 fb ff ff       	call   80104a00 <argstr>
...
80104eec:	e8 0f fb ff ff       	call   80104a00 <argstr>
...
80105023:	e8 d8 f9 ff ff       	call   80104a00 <argstr>
...
801050d2:	e8 99 f5 ff ff       	call   80104670 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105203:	e8 f8 f7 ff ff       	call   80104a00 <argstr>
...
8010521c:	e8 2f f7 ff ff       	call   80104950 <argint>
...
8010526e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
80105270:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
801052d8:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801052db:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
...
80105348:	e8 b3 f6 ff ff       	call   80104a00 <argstr>
...
801053b8:	e8 43 f6 ff ff       	call   80104a00 <argstr>
...
801053cd:	e8 7e f5 ff ff       	call   80104950 <argint>
  if((argstr(0, &path)) < 0 ||
...
801053e2:	e8 69 f5 ff ff       	call   80104950 <argint>
     argint(1, &major) < 0 ||
...
80105461:	e8 9a f5 ff ff       	call   80104a00 <argstr>
...
80105509:	e8 f2 f4 ff ff       	call   80104a00 <argstr>
...
80105525:	e8 26 f4 ff ff       	call   80104950 <argint>
...
8010554a:	e8 21 f1 ff ff       	call   80104670 <memset>
...
8010556c:	e8 3f f3 ff ff       	call   801048b0 <fetchint>
...
80105590:	e8 5b f3 ff ff       	call   801048f0 <fetchstr>
...
80105605:	e8 96 f3 ff ff       	call   801049a0 <argptr>
...
801056ae:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
801056b0:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
  }
  fd[0] = fd0;
...
80105720:	e8 2b f2 ff ff       	call   80104950 <argint>
...
80105770 <sys_getreadcount>:

int
sys_getreadcount(void) //MY FUNCTION
{
...
8010577f:	8b 40 14             	mov    0x14(%eax),%eax
}
80105782:	c9                   	leave  
80105783:	c3                   	ret    
...
80105790 <sys_resetread>:

int
sys_resetread(void){ //MY FUNCTION 2 
...
80105801:	e8 4a f1 ff ff       	call   80104950 <argint>
...
80105814:	68 80 4d 11 80       	push   $0x80114d80
80105819:	e8 42 ed ff ff       	call   80104560 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010581e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105821:	8b 1d c0 55 11 80    	mov    0x801155c0,%ebx
  while(ticks - ticks0 < n){
...
80105833:	68 80 4d 11 80       	push   $0x80114d80
80105838:	68 c0 55 11 80       	push   $0x801155c0
8010583d:	e8 de e6 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105842:	a1 c0 55 11 80       	mov    0x801155c0,%eax
...
80105883:	68 80 4d 11 80       	push   $0x80114d80
...
801058b0:	e8 ab ec ff ff       	call   80104560 <acquire>
  xticks = ticks;
801058b5:	8b 1d c0 55 11 80    	mov    0x801155c0,%ebx
  release(&tickslock);
801058bb:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
801058c2:	e8 59 ed ff ff       	call   80104620 <release>
  return xticks;
}
