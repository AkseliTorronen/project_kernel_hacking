...
00000100 <ls>:
{
 ...
 113:	6a 00                	push   $0x0
 115:	57                   	push   %edi
 116:	e8 d8 04 00 00       	call   5f3 <open>
 ...
 131:	56                   	push   %esi
 132:	50                   	push   %eax
 133:	e8 d3 04 00 00       	call   60b <fstat>
 ...
 159:	53                   	push   %ebx
 15a:	e8 7c 04 00 00       	call   5db <close>
...
stat(const char *n, struct stat *st)
{
 ...
 4f1:	e8 fd 00 00 00       	call   5f3 <open>
  if(fd < 0)
 ...
 505:	50                   	push   %eax
 506:	e8 00 01 00 00       	call   60b <fstat>
  close(fd);
 50b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 50e:	89 c6                	mov    %eax,%esi
  close(fd);
 510:	e8 c6 00 00 00       	call   5db <close>
  return r;
