  ...
  1f:	31 db                	xor    %ebx,%ebx
{
  ...
  a6:	50                   	push   %eax
  a7:	e8 47 03 00 00       	call   3f3 <open>
...
//    printf(fd, "%d\n", i);
  ...
  c0:	56                   	push   %esi
  c1:	57                   	push   %edi
  c2:	e8 0c 03 00 00       	call   3d3 <write>
  for(i = 0; i < 20; i++)
  ...
  d2:	57                   	push   %edi
  d3:	e8 03 03 00 00       	call   3db <close>
  ...
  f5:	50                   	push   %eax
  f6:	e8 f8 02 00 00       	call   3f3 <open>
...
stat(const char *n, struct stat *st)
{
 ...
 2f1:	e8 fd 00 00 00       	call   3f3 <open>
  if(fd < 0)
 ...
 305:	50                   	push   %eax
 306:	e8 00 01 00 00       	call   40b <fstat>
  close(fd);
 30b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 30e:	89 c6                	mov    %eax,%esi
  close(fd);
 310:	e8 c6 00 00 00       	call   3db <close>
  return r;
