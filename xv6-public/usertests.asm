...
00000120 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
     ...
     141:	e8 b5 38 00 00       	call   39fb <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     155:	e8 a9 38 00 00       	call   3a03 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     16d:	e8 71 38 00 00       	call   39e3 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     181:	e8 7d 38 00 00       	call   3a03 <chdir>
...
00000210 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     244:	e8 b2 37 00 00       	call   39fb <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     25c:	e8 a2 37 00 00       	call   3a03 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     274:	e8 6a 37 00 00       	call   39e3 <unlink>
...
00000310 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     331:	e8 c5 36 00 00       	call   39fb <mkdir>
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     356:	e8 78 36 00 00       	call   39d3 <open>
    if(fd >= 0){
  ...
  if(unlink("oidir") != 0){
     ...
     391:	e8 4d 36 00 00       	call   39e3 <unlink>
...
00000410 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     433:	e8 9b 35 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     442:	50                   	push   %eax
     443:	e8 73 35 00 00       	call   39bb <close>
  fd = open("doesnotexist", 0);
     448:	5a                   	pop    %edx
     449:	59                   	pop    %ecx
     44a:	6a 00                	push   $0x0
     44c:	68 55 3f 00 00       	push   $0x3f55
     451:	e8 7d 35 00 00       	call   39d3 <open>
  if(fd >= 0){
...
000004b0 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4d8:	e8 f6 34 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     512:	56                   	push   %esi
     513:	e8 9b 34 00 00       	call   39b3 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     52e:	56                   	push   %esi
     52f:	e8 7f 34 00 00       	call   39b3 <write>
  ...
  close(fd);
     ...
     55e:	e8 58 34 00 00       	call   39bb <close>
  fd = open("small", O_RDONLY);
     563:	5b                   	pop    %ebx
     564:	5e                   	pop    %esi
     565:	6a 00                	push   $0x0
     567:	68 9f 3f 00 00       	push   $0x3f9f
     56c:	e8 62 34 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  close(fd);
     ...
     5c8:	e8 ee 33 00 00       	call   39bb <close>
  if(unlink("small") < 0){
     5cd:	c7 04 24 9f 3f 00 00 	movl   $0x3f9f,(%esp)
     5d4:	e8 0a 34 00 00       	call   39e3 <unlink>
...
00000690 <writetest1>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     6b8:	e8 16 33 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6e3:	56                   	push   %esi
     6e4:	e8 ca 32 00 00       	call   39b3 <write>
  ...
  close(fd);
     ...
     705:	56                   	push   %esi
     706:	e8 b0 32 00 00       	call   39bb <close>
  fd = open("big", O_RDONLY);
     70b:	5b                   	pop    %ebx
     70c:	5e                   	pop    %esi
     70d:	6a 00                	push   $0x0
     70f:	68 e7 40 00 00       	push   $0x40e7
     714:	e8 ba 32 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     770:	53                   	push   %ebx
     771:	e8 45 32 00 00       	call   39bb <close>
  if(unlink("big") < 0){
     776:	c7 04 24 e7 40 00 00 	movl   $0x40e7,(%esp)
     77d:	e8 61 32 00 00       	call   39e3 <unlink>
     ...
     868:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     8ae:	e8 20 31 00 00       	call   39d3 <open>
    close(fd);
     8b3:	89 04 24             	mov    %eax,(%esp)
     8b6:	e8 00 31 00 00       	call   39bb <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8f1:	e8 ed 30 00 00       	call   39e3 <unlink>
  for(i = 0; i < 52; i++){
...
00000920 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
     ...
     941:	e8 b5 30 00 00       	call   39fb <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     955:	e8 a9 30 00 00       	call   3a03 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     96d:	e8 91 30 00 00       	call   3a03 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     981:	e8 5d 30 00 00       	call   39e3 <unlink>
...
00000a10 <exectest>:
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     a36:	e8 90 2f 00 00       	call   39cb <exec>
     ...
     a69:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     aa1:	e8 15 2f 00 00       	call   39bb <close>
    total = 0;
  ...
  seq = 0;
    ...
    close(fds[0]);
     b23:	e8 93 2e 00 00       	call   39bb <close>
     ...
     b59:	e8 55 2e 00 00       	call   39b3 <write>
    ...
    close(fds[0]);
     ...
     b84:	e8 32 2e 00 00       	call   39bb <close>
    wait();
...
00000c00 <preempt>:
{
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c89:	e8 2d 2d 00 00       	call   39bb <close>
  ...
  close(pfds[1]);
     ...
     c9e:	e8 18 2d 00 00       	call   39bb <close>
  ...
  close(pfds[0]);
     ...
     cc6:	e8 f0 2c 00 00       	call   39bb <close>
  printf(1, "kill... ");
     ccb:	58                   	pop    %eax
     ccc:	5a                   	pop    %edx
  ...
  kill(pid2);
     ...
     ce4:	e8 da 2c 00 00       	call   39c3 <kill>
  kill(pid3);
     ce9:	89 1c 24             	mov    %ebx,(%esp)
     cec:	e8 d2 2c 00 00       	call   39c3 <kill>
  printf(1, "wait... ");
     cf1:	59                   	pop    %ecx
     cf2:	5b                   	pop    %ebx
...
00000de0 <mem>:
{
  ...
  ppid = getpid();
     dfa:	e8 14 2c 00 00       	call   3a13 <getpid>
  ...
  if((pid = fork()) == 0){
    ...
    exit();
     ...
     e92:	e8 2c 2b 00 00       	call   39c3 <kill>
      exit();
...
00000eb0 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     ed0:	e8 0e 2b 00 00       	call   39e3 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     ed5:	5b                   	pop    %ebx
     ed6:	5e                   	pop    %esi
     ed7:	68 02 02 00 00       	push   $0x202
     edc:	68 93 42 00 00       	push   $0x4293
     ee1:	e8 ed 2a 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f2a:	56                   	push   %esi
     f2b:	57                   	push   %edi
     f2c:	e8 82 2a 00 00       	call   39b3 <write>
  ...
  close(fd);
     ...
     f64:	e8 52 2a 00 00       	call   39bb <close>
  fd = open("sharedfd", 0);
     f69:	58                   	pop    %eax
     f6a:	5a                   	pop    %edx
     f6b:	6a 00                	push   $0x0
     f6d:	68 93 42 00 00       	push   $0x4293
     f72:	e8 5c 2a 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     fd6:	e8 e0 29 00 00       	call   39bb <close>
  unlink("sharedfd");
     fdb:	c7 04 24 93 42 00 00 	movl   $0x4293,(%esp)
     fe2:	e8 fc 29 00 00       	call   39e3 <unlink>
    ...
    107f:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    10b2:	56                   	push   %esi
    10b3:	e8 2b 29 00 00       	call   39e3 <unlink>
    pid = fork();
  ...
  for(i = 0; i < 2; i++){
    ...
    fd = open(fname, 0);
    1101:	e8 cd 28 00 00       	call   39d3 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    1154:	e8 62 28 00 00       	call   39bb <close>
    if(total != 12*500){
    ...
    116e:	e8 70 28 00 00       	call   39e3 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    11bb:	56                   	push   %esi
    11bc:	e8 12 28 00 00       	call   39d3 <open>
      if(fd < 0){
    ...
    11f5:	56                   	push   %esi
    11f6:	e8 b8 27 00 00       	call   39b3 <write>
    ...
    127a:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i < N; i++){
    ...
    12ff:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    1302:	e8 cc 26 00 00       	call   39d3 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1328:	50                   	push   %eax
    1329:	e8 8d 26 00 00       	call   39bb <close>
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1368:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    136b:	e8 73 26 00 00       	call   39e3 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    13e4:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    13e7:	e8 e7 25 00 00       	call   39d3 <open>
        if(fd < 0){
    ...
    13f6:	50                   	push   %eax
    13f7:	e8 bf 25 00 00       	call   39bb <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1413:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    1416:	e8 c8 25 00 00       	call   39e3 <unlink>
...
000014a0 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14c4:	e8 0a 25 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    14e0:	50                   	push   %eax
    14e1:	e8 cd 24 00 00       	call   39b3 <write>
  close(fd);
    14e6:	89 1c 24             	mov    %ebx,(%esp)
    14e9:	e8 cd 24 00 00       	call   39bb <close>
  fd = open("unlinkread", O_RDWR);
    14ee:	58                   	pop    %eax
    14ef:	5a                   	pop    %edx
    14f0:	6a 02                	push   $0x2
    14f2:	68 45 43 00 00       	push   $0x4345
    14f7:	e8 d7 24 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    1511:	e8 cd 24 00 00       	call   39e3 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    152e:	e8 a0 24 00 00       	call   39d3 <open>
  write(fd1, "yyy", 3);
  ...
  write(fd1, "yyy", 3);
    ...
    153f:	50                   	push   %eax
    1540:	e8 6e 24 00 00       	call   39b3 <write>
  close(fd1);
    1545:	89 34 24             	mov    %esi,(%esp)
    1548:	e8 6e 24 00 00       	call   39bb <close>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    157f:	53                   	push   %ebx
    1580:	e8 2e 24 00 00       	call   39b3 <write>
  ...
  close(fd);
    ...
    1590:	53                   	push   %ebx
    1591:	e8 25 24 00 00       	call   39bb <close>
  unlink("unlinkread");
    1596:	c7 04 24 45 43 00 00 	movl   $0x4345,(%esp)
    159d:	e8 41 24 00 00       	call   39e3 <unlink>
...
00001630 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1687:	50                   	push   %eax
    1688:	e8 26 23 00 00       	call   39b3 <write>
  ...
  close(fd);
    ...
    169c:	53                   	push   %ebx
    169d:	e8 19 23 00 00       	call   39bb <close>
  if(link("lf1", "lf2") < 0){
    16a2:	5b                   	pop    %ebx
    16a3:	58                   	pop    %eax
    16a4:	68 0a 44 00 00       	push   $0x440a
    16a9:	68 06 44 00 00       	push   $0x4406
    16ae:	e8 40 23 00 00       	call   39f3 <link>
  ...
  unlink("lf1");
    ...
    16c6:	e8 18 23 00 00       	call   39e3 <unlink>
  if(open("lf1", 0) >= 0){
    16cb:	58                   	pop    %eax
    16cc:	5a                   	pop    %edx
    16cd:	6a 00                	push   $0x0
    16cf:	68 06 44 00 00       	push   $0x4406
    16d4:	e8 fa 22 00 00       	call   39d3 <open>
  ...
  fd = open("lf2", 0);
    ...
    16ee:	e8 e0 22 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    1722:	53                   	push   %ebx
    1723:	e8 93 22 00 00       	call   39bb <close>
  if(link("lf2", "lf2") >= 0){
    1728:	58                   	pop    %eax
    1729:	5a                   	pop    %edx
    172a:	68 0a 44 00 00       	push   $0x440a
    172f:	68 0a 44 00 00       	push   $0x440a
    1734:	e8 ba 22 00 00       	call   39f3 <link>
  ...
  unlink("lf2");
    ...
    174c:	e8 92 22 00 00       	call   39e3 <unlink>
  if(link("lf2", "lf1") >= 0){
    1751:	59                   	pop    %ecx
    1752:	5b                   	pop    %ebx
    1753:	68 06 44 00 00       	push   $0x4406
    1758:	68 0a 44 00 00       	push   $0x440a
    175d:	e8 91 22 00 00       	call   39f3 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1776:	e8 78 22 00 00       	call   39f3 <link>
    ...
    1859:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1899:	53                   	push   %ebx
    189a:	e8 34 21 00 00       	call   39d3 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    18a9:	83 c6 01             	add    $0x1,%esi
      close(fd);
    18ac:	50                   	push   %eax
    18ad:	e8 09 21 00 00       	call   39bb <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    18cd:	e8 11 21 00 00       	call   39e3 <unlink>
    pid = fork();
    ...
    18f4:	53                   	push   %ebx
    18f5:	e8 d9 20 00 00       	call   39d3 <open>
      if(fd < 0){
    ...
    1929:	e8 c5 20 00 00       	call   39f3 <link>
  ...
  for(i = 0; i < 40; i++){
    ...
    194c:	e8 a2 20 00 00       	call   39f3 <link>
  ...
  fd = open(".", 0);
    ...
    197e:	e8 50 20 00 00       	call   39d3 <open>
  n = 0;
  ...
  close(fd);
    ...
    19e3:	56                   	push   %esi
    19e4:	e8 d2 1f 00 00       	call   39bb <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    1a0c:	53                   	push   %ebx
    1a0d:	e8 d1 1f 00 00       	call   39e3 <unlink>
      unlink(file);
    1a12:	89 1c 24             	mov    %ebx,(%esp)
    1a15:	e8 c9 1f 00 00       	call   39e3 <unlink>
      unlink(file);
  ...
  for(i = 0; i < 40; i++){
    ...
    1a78:	6a 00                	push   $0x0
    1a7a:	53                   	push   %ebx
    1a7b:	e8 53 1f 00 00       	call   39d3 <open>
    1a80:	89 04 24             	mov    %eax,(%esp)
    1a83:	e8 33 1f 00 00       	call   39bb <close>
      close(open(file, 0));
    1a88:	58                   	pop    %eax
    1a89:	5a                   	pop    %edx
    1a8a:	6a 00                	push   $0x0
    1a8c:	53                   	push   %ebx
    1a8d:	e8 41 1f 00 00       	call   39d3 <open>
    1a92:	89 04 24             	mov    %eax,(%esp)
    1a95:	e8 21 1f 00 00       	call   39bb <close>
      close(open(file, 0));
    1a9a:	59                   	pop    %ecx
    1a9b:	58                   	pop    %eax
    1a9c:	6a 00                	push   $0x0
    1a9e:	53                   	push   %ebx
    1a9f:	e8 2f 1f 00 00       	call   39d3 <open>
    1aa4:	89 04 24             	mov    %eax,(%esp)
    1aa7:	e8 0f 1f 00 00       	call   39bb <close>
      close(open(file, 0));
    1aac:	58                   	pop    %eax
    1aad:	5a                   	pop    %edx
    1aae:	6a 00                	push   $0x0
    1ab0:	53                   	push   %ebx
    1ab1:	e8 1d 1f 00 00       	call   39d3 <open>
    1ab6:	89 04 24             	mov    %eax,(%esp)
    1ab9:	e8 fd 1e 00 00       	call   39bb <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1b41:	50                   	push   %eax
    1b42:	e8 74 1e 00 00       	call   39bb <close>
...
00001b50 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1b70:	e8 6e 1e 00 00       	call   39e3 <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1bad:	e8 31 1e 00 00       	call   39e3 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1be6:	e8 e8 1d 00 00       	call   39d3 <open>
    1beb:	89 04 24             	mov    %eax,(%esp)
    1bee:	e8 c8 1d 00 00       	call   39bb <close>
  ...
  printf(1, "linkunlink ok\n");
    ...
    1c2d:	e8 c1 1d 00 00       	call   39f3 <link>
...
00001c60 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c80:	e8 5e 1d 00 00       	call   39e3 <unlink>
  fd = open("bd", O_CREATE);
    1c85:	5a                   	pop    %edx
    1c86:	59                   	pop    %ecx
    1c87:	68 00 02 00 00       	push   $0x200
    1c8c:	68 55 45 00 00       	push   $0x4555
    1c91:	e8 3d 1d 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    1ca9:	50                   	push   %eax
    1caa:	e8 0c 1d 00 00       	call   39bb <close>
    ...
    if(link("bd", name) != 0){
    1cdf:	e8 0f 1d 00 00       	call   39f3 <link>
  ...
  unlink("bd");
    ...
    1d00:	e8 de 1c 00 00       	call   39e3 <unlink>
    ...
    if(unlink(name) != 0){
    1d32:	e8 ac 1c 00 00       	call   39e3 <unlink>
...
00001da0 <subdir>:
{
  ...
  unlink("ff");
    ...
    1dbe:	e8 20 1c 00 00       	call   39e3 <unlink>
  if(mkdir("dd") != 0){
    1dc3:	c7 04 24 c8 46 00 00 	movl   $0x46c8,(%esp)
    1dca:	e8 2c 1c 00 00       	call   39fb <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1de7:	e8 e7 1b 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1e03:	50                   	push   %eax
    1e04:	e8 aa 1b 00 00       	call   39b3 <write>
  close(fd);
    1e09:	89 1c 24             	mov    %ebx,(%esp)
    1e0c:	e8 aa 1b 00 00       	call   39bb <close>
  if(unlink("dd") >= 0){
    1e11:	c7 04 24 c8 46 00 00 	movl   $0x46c8,(%esp)
    1e18:	e8 c6 1b 00 00       	call   39e3 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1e30:	e8 c6 1b 00 00       	call   39fb <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1e4d:	e8 81 1b 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1e69:	50                   	push   %eax
    1e6a:	e8 44 1b 00 00       	call   39b3 <write>
  close(fd);
    1e6f:	89 1c 24             	mov    %ebx,(%esp)
    1e72:	e8 44 1b 00 00       	call   39bb <close>
  fd = open("dd/dd/../ff", 0);
    1e77:	58                   	pop    %eax
    1e78:	5a                   	pop    %edx
    1e79:	6a 00                	push   $0x0
    1e7b:	68 22 46 00 00       	push   $0x4622
    1e80:	e8 4e 1b 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    1ec1:	53                   	push   %ebx
    1ec2:	e8 f4 1a 00 00       	call   39bb <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1ec7:	59                   	pop    %ecx
    1ec8:	5b                   	pop    %ebx
    1ec9:	68 62 46 00 00       	push   $0x4662
    1ece:	68 fe 45 00 00       	push   $0x45fe
    1ed3:	e8 1b 1b 00 00       	call   39f3 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1eeb:	e8 f3 1a 00 00       	call   39e3 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f05:	e8 c9 1a 00 00       	call   39d3 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1f1d:	e8 e1 1a 00 00       	call   3a03 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1f35:	e8 c9 1a 00 00       	call   3a03 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1f4d:	e8 b1 1a 00 00       	call   3a03 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1f65:	e8 99 1a 00 00       	call   3a03 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1f7f:	e8 4f 1a 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    1fb3:	53                   	push   %ebx
    1fb4:	e8 02 1a 00 00       	call   39bb <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1fb9:	58                   	pop    %eax
    1fba:	5a                   	pop    %edx
    1fbb:	6a 00                	push   $0x0
    1fbd:	68 fe 45 00 00       	push   $0x45fe
    1fc2:	e8 0c 1a 00 00       	call   39d3 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1fdf:	e8 ef 19 00 00       	call   39d3 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1ffc:	e8 d2 19 00 00       	call   39d3 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2019:	e8 b5 19 00 00       	call   39d3 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2033:	e8 9b 19 00 00       	call   39d3 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    204d:	e8 81 19 00 00       	call   39d3 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    206a:	e8 84 19 00 00       	call   39f3 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2087:	e8 67 19 00 00       	call   39f3 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    20a4:	e8 4a 19 00 00       	call   39f3 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    20bc:	e8 3a 19 00 00       	call   39fb <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    20d4:	e8 22 19 00 00       	call   39fb <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    20ec:	e8 0a 19 00 00       	call   39fb <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2104:	e8 da 18 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    211c:	e8 c2 18 00 00       	call   39e3 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    2134:	e8 ca 18 00 00       	call   3a03 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    214c:	e8 b2 18 00 00       	call   3a03 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    2164:	e8 7a 18 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    217c:	e8 62 18 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2194:	e8 4a 18 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    21ac:	e8 32 18 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    21c4:	e8 1a 18 00 00       	call   39e3 <unlink>
...
00002490 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    24b4:	e8 2a 15 00 00       	call   39e3 <unlink>
    ...
    24cd:	e8 01 15 00 00       	call   39d3 <open>
    if(fd < 0){
    ...
    24e4:	50                   	push   %eax
    24e5:	e8 c9 14 00 00       	call   39b3 <write>
      if(cc != sz){
    ...
    24fa:	56                   	push   %esi
    24fb:	e8 b3 14 00 00       	call   39b3 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2510:	56                   	push   %esi
    2511:	e8 a5 14 00 00       	call   39bb <close>
    unlink("bigwrite");
    2516:	c7 04 24 c4 48 00 00 	movl   $0x48c4,(%esp)
    251d:	e8 c1 14 00 00       	call   39e3 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
...
00002570 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    2590:	e8 4e 14 00 00       	call   39e3 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2595:	58                   	pop    %eax
    2596:	5a                   	pop    %edx
    2597:	68 02 02 00 00       	push   $0x202
    259c:	68 20 49 00 00       	push   $0x4920
    25a1:	e8 2d 14 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    25d8:	56                   	push   %esi
    25d9:	e8 d5 13 00 00       	call   39b3 <write>
  ...
  close(fd);
    ...
    25f7:	56                   	push   %esi
    25f8:	e8 be 13 00 00       	call   39bb <close>
  fd = open("bigfile", 0);
    25fd:	5e                   	pop    %esi
    25fe:	5f                   	pop    %edi
    25ff:	6a 00                	push   $0x0
    2601:	68 20 49 00 00       	push   $0x4920
    2606:	e8 c8 13 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    266d:	56                   	push   %esi
    266e:	e8 48 13 00 00       	call   39bb <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    268a:	e8 54 13 00 00       	call   39e3 <unlink>
...
00002740 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    275d:	e8 99 12 00 00       	call   39fb <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2775:	e8 81 12 00 00       	call   39fb <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2792:	e8 3c 12 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    27a5:	50                   	push   %eax
    27a6:	e8 10 12 00 00       	call   39bb <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    27ab:	58                   	pop    %eax
    27ac:	5a                   	pop    %edx
    27ad:	6a 00                	push   $0x0
    27af:	68 78 52 00 00       	push   $0x5278
    27b4:	e8 1a 12 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    27c3:	50                   	push   %eax
    27c4:	e8 f2 11 00 00       	call   39bb <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    27c9:	c7 04 24 ec 49 00 00 	movl   $0x49ec,(%esp)
    27d0:	e8 26 12 00 00       	call   39fb <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    27e4:	e8 12 12 00 00       	call   39fb <mkdir>
...
00002880 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    289d:	e8 59 11 00 00       	call   39fb <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    28b5:	e8 49 11 00 00       	call   3a03 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    28cd:	e8 11 11 00 00       	call   39e3 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    28e5:	e8 f9 10 00 00       	call   39e3 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    28fd:	e8 01 11 00 00       	call   3a03 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2915:	e8 c9 10 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2929:	e8 b5 10 00 00       	call   39e3 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    293d:	e8 a1 10 00 00       	call   39e3 <unlink>
...
00002a00 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    2a23:	e8 ab 0f 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2a36:	50                   	push   %eax
    2a37:	e8 7f 0f 00 00       	call   39bb <close>
  if(chdir("dirfile") == 0){
    2a3c:	c7 04 24 d5 4a 00 00 	movl   $0x4ad5,(%esp)
    2a43:	e8 bb 0f 00 00       	call   3a03 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2a5d:	e8 71 0f 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2a7a:	e8 54 0f 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2a92:	e8 64 0f 00 00       	call   39fb <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2aaa:	e8 34 0f 00 00       	call   39e3 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2ac7:	e8 27 0f 00 00       	call   39f3 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2adf:	e8 ff 0e 00 00       	call   39e3 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2af9:	e8 d5 0e 00 00       	call   39d3 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2b13:	e8 bb 0e 00 00       	call   39d3 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2b24:	50                   	push   %eax
    2b25:	e8 89 0e 00 00       	call   39b3 <write>
  ...
  close(fd);
    ...
    2b34:	53                   	push   %ebx
    2b35:	e8 81 0e 00 00       	call   39bb <close>
    ...
    2c08:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2c28:	e8 ce 0d 00 00       	call   39fb <mkdir>
    ...
    2c40:	e8 be 0d 00 00       	call   3a03 <chdir>
  ...
  chdir("/");
    ...
    2cd8:	e8 26 0d 00 00       	call   3a03 <chdir>
    ...
    2dd8:	31 ff                	xor    %edi,%edi
{
  ...
  *lastaddr = 99;
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2f68:	e8 a6 0a 00 00       	call   3a13 <getpid>
  ...
  c = sbrk(4096);
    ...
    2fff:	50                   	push   %eax
    3000:	e8 be 09 00 00       	call   39c3 <kill>
    wait();
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3077:	e8 37 09 00 00       	call   39b3 <write>
    ...
    3110:	e8 ae 08 00 00       	call   39c3 <kill>
      exit();
    ...
    3208:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    324c:	e8 72 07 00 00       	call   39c3 <kill>
    wait();
    ...
    325e:	e8 90 07 00 00       	call   39f3 <link>
...
00003330 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    333f:	e8 9f 06 00 00       	call   39e3 <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3365:	e8 69 06 00 00       	call   39d3 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    3378:	50                   	push   %eax
    3379:	e8 3d 06 00 00       	call   39bb <close>
  unlink("bigarg-ok");
    337e:	c7 04 24 66 4d 00 00 	movl   $0x4d66,(%esp)
    3385:	e8 59 06 00 00       	call   39e3 <unlink>
}
    ...
    33cb:	e8 fb 05 00 00       	call   39cb <exec>
    ...
    33ee:	e8 e0 05 00 00       	call   39d3 <open>
    close(fd);
    33f3:	89 04 24             	mov    %eax,(%esp)
    33f6:	e8 c0 05 00 00       	call   39bb <close>
    exit();
    ...
    3439:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    34da:	50                   	push   %eax
    34db:	e8 f3 04 00 00       	call   39d3 <open>
    if(fd < 0){
    ...
    34ff:	57                   	push   %edi
    3500:	e8 ae 04 00 00       	call   39b3 <write>
      if(cc < 512)
    ...
    3522:	e8 94 04 00 00       	call   39bb <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    35d9:	50                   	push   %eax
    35da:	e8 04 04 00 00       	call   39e3 <unlink>
  while(nfiles >= 0){
...
00003690 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    36a2:	e8 2c 03 00 00       	call   39d3 <open>
  if (fd < 0) {
  ...
  close(fd);
    ...
    36cc:	e8 ea 02 00 00       	call   39bb <close>
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    38d1:	e8 fd 00 00 00       	call   39d3 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    38e5:	50                   	push   %eax
    38e6:	e8 00 01 00 00       	call   39eb <fstat>
  close(fd);
    38eb:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    38ee:	89 c6                	mov    %eax,%esi
  close(fd);
    38f0:	e8 c6 00 00 00       	call   39bb <close>
  return r;
...
SYSCALL(getreadcount) //My change
    39a3:	b8 16 00 00 00       	mov    $0x16,%eax
    39a8:	cd 40                	int    $0x40
    39aa:	c3                   	ret    

000039ab <resetread>:
SYSCALL(resetread) //My change
    ...
    3a4c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3abe:	56                   	push   %esi
    3abf:	57                   	push   %edi
    3ac0:	e8 ee fe ff ff       	call   39b3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3b39:	e8 75 fe ff ff       	call   39b3 <write>
  ...
  write(fd, &c, 1);
    ...
    3b99:	e8 15 fe ff ff       	call   39b3 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
    ...
    3bad:	e8 01 fe ff ff       	call   39b3 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    3c24:	e8 8a fd ff ff       	call   39b3 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    3c9b:	57                   	push   %edi
    3c9c:	53                   	push   %ebx
    3c9d:	e8 11 fd ff ff       	call   39b3 <write>
        while(*s != 0){
