...
stat(const char *n, struct stat *st)
{
 ...
 341:	e8 fd 00 00 00       	call   443 <open>
  if(fd < 0)
 ...
 355:	50                   	push   %eax
 356:	e8 00 01 00 00       	call   45b <fstat>
  close(fd);
 35b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 35e:	89 c6                	mov    %eax,%esi
  close(fd);
 360:	e8 c6 00 00 00       	call   42b <close>
  return r;
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a9:	e8 75 fe ff ff       	call   423 <write>
 ...
 61d:	e8 01 fe ff ff       	call   423 <write>
  for(i = 0; fmt[i]; i++){
 ...
 691:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 694:	e8 8a fd ff ff       	call   423 <write>
        ap++;
 ...
 70b:	57                   	push   %edi
 70c:	53                   	push   %ebx
 70d:	e8 11 fd ff ff       	call   423 <write>
        while(*s != 0){
